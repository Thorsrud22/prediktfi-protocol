...
describe('creatorScore', () => {
  ...
  describe('volumeScoreFromNotional', () => {
    it('should calculate volume score correctly', () => {
      ...
      expect(volumeScoreFromNotional(50000)).toBeCloseTo(0.5, 2);
      expect(volumeScoreFromNotional(100000)).toBeCloseTo(0.63, 2);
    });
    ...
    it('should use custom normalization', () => {
      ...
      expect(volumeScoreFromNotional(customNorm, customNorm)).toBeCloseTo(0.5, 2);
    });
  });
  ...
  describe('recencyWeights', () => {
    it('should generate exponential decay weights', () => {
      ...
      expect(weights[0]).toBeCloseTo(1, 2); // First weight should be close to 1
    });
  ...
  describe('weightedAverage', () => {
    ...
    it('should handle unequal weights', () => {
      ...
      expect(weightedAverage(values, weights)).toBe(1.7);
    });
  ...
  describe('calculateTrend', () => {
    ...
    it('should use 1% threshold', () => {
      ...
      expect(calculateTrend(0.6, 0.593)).toBe('down'); // >1% decrease
    });
  });
