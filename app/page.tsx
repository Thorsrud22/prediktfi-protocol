...
export default function Home() {
  ...
  const handlePlaceBet = () => {
    ...
    alert(`Placing ${betAmount} SOL bet on ${betSide.toUpperCase()} for: ${selectedMarket.title}`);
  };

  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(135deg, #0a0d1f 0%, #1a1d4b 50%, #0a0d1f 100%)',
      color: 'white',
        ...
        {!connected ? (
          ...
          <div style={{ textAlign: 'center', paddingTop: '4rem' }}>
            ...
            <p style={{ fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 2rem', opacity: 0.8 }}>
              Connect your Phantom wallet to start trading prediction markets on Solana
            </p>
            <div style={{ 
              ...
              {mockMarkets.map((market) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '1.5rem',
                    borderRadius: '1rem',
                    border: selectedMarket?.id === market.id 
                      ? '2px solid #60a5fa' 
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ 
                        ...
                        <div style={{ fontWeight: 'bold', color: '#22c55e' }}>YES</div>
                        <div style={{ fontSize: '1.1rem' }}>${market.yesPrice.toFixed(2)}</div>
                      </div>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ 
                        ...
                        <div style={{ fontWeight: 'bold', color: '#ef4444' }}>NO</div>
                        <div style={{ fontSize: '1.1rem' }}>${market.noPrice.toFixed(2)}</div>
                      </div>
                    </div>
                  </div>
                  
                  <div style={{ fontSize: '0.8rem', opacity: 0.6 }}>
                    Volume: {market.totalVolume.toLocaleString()} SOL • Ends: {market.endDate}
                  </div>
                </div>
              ))}
            </div>
              ...
              <div style={{
                  ...
                  <div style={{ display: 'flex', gap: '1rem' }}>
                    <button
                      ...
                      style={{
                        ...
                        padding: '0.75rem',
                        borderRadius: '0.5rem',
                        border: betSide === 'yes' ? '2px solid #22c55e' : '1px solid rgba(34, 197, 94, 0.3)',
                        background: betSide === 'yes' ? 'rgba(34, 197, 94, 0.3)' : 'rgba(34, 197, 94, 0.1)',
                        color: '#22c55e',
                        fontWeight: 'bold',
                        cursor: 'pointer'
                      }}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        padding: '0.75rem',
                        borderRadius: '0.5rem',
                        border: betSide === 'no' ? '2px solid #ef4444' : '1px solid rgba(239, 68, 68, 0.3)',
                        background: betSide === 'no' ? 'rgba(239, 68, 68, 0.3)' : 'rgba(239, 68, 68, 0.1)',
                        color: '#ef4444',
                        fontWeight: 'bold',
                        cursor: 'pointer'
                      }}
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '0.5rem',
                    border: 'none',
                    background: (!betAmount || !betSide) 
                      ? 'rgba(255, 255, 255, 0.1)' 
                      : 'linear-gradient(90deg, #2563eb, #7c3aed)',
                    color: (!betAmount || !betSide) ? 'rgba(255, 255, 255, 0.5)' : 'white',
                    fontSize: '1.1rem',
                    fontWeight: 'bold',
                ...
                >
                  {!betAmount || !betSide ? 'Select Side & Amount' : `Place ${betAmount} SOL Bet`}
                </button>
              </div>
            )}
          </div>
