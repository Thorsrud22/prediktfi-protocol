  ...
  return (
    ...
    >
      <div className="relative z-[1] mx-auto max-w-[1100px] px-6 py-20 sm:py-24 md:py-28">
        ...
        {/* Heading */}
        <h1
          className="mt-5 font-extrabold leading-tight text-[clamp(2.25rem,7vw,5.5rem)] text-[color:var(--text)]"
        >
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-full bg-[color:var(--accent)] px-5 py-2.5 text-sm font-semibold text-black shadow-token outline-none transition-colors hover:brightness-110 focus-visible:ring-2 focus-visible:ring-[color:var(--accent)]/60"
          >
            Launch App
          </Link>
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full border border-[var(--border)] bg-[color:var(--surface)]/60 px-5 py-2.5 text-sm font-semibold text-[color:var(--text)]/90 outline-none transition-colors hover:bg-[color:var(--surface)] focus-visible:ring-2 focus-visible:ring-[color:var(--accent)]/50"
          >
            View Docs
          </Link>
        </div>
