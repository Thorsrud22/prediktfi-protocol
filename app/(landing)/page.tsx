  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed top-3 left-4 sm:left-6 z-50">
        ...
        >
          <span className="relative flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full transition-all duration-300 group-hover:scale-110">
            <Image
              src="/images/predikt-logo-white.svg"
              alt="Predikt logo"
              width={36}
              height={36}
