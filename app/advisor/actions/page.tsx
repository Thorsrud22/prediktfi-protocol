...
import {
  ...
  saveIntents,
  upsertIntent,
  removeIntent as removeWalletIntent,
  ...
  return (
    <div className="rounded-xl border border-blue-600 bg-blue-900/20 p-6 text-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, asset: e.target.value.toUpperCase() }))
              }
          ...
          <div>
            ...
            <select
              value={formData.side}
              onChange={e =>
                setFormData(prev => ({ ...prev, side: e.target.value as 'Long' | 'Short' }))
              }
              className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, probability: parseInt(e.target.value) || 0 }))
              }
              className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, confidence: parseInt(e.target.value) || 0 }))
              }
              className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
        ...
        {/* Thesis */}
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">Trading Thesis *</label>
          <textarea
...
export default function ActionsPage() {
  ...
  useEffect(() => {
    ...
    const normalized = (Array.isArray(raw) ? raw : [])
      .map(normalizeIntent)
      .filter((item): item is UiIntent => item !== null);
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      ...
      <p className="text-sm text-slate-300 mb-6">
        Monitor and analyze trading opportunities. No trades are executed automatically.
      </p>
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Trading intents created from AI predictions in Studio
            </p>
          </div>
        </div>
          ...
          <div className="rounded-xl border border-blue-600 bg-blue-900/20 p-6 text-slate-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-blue-400">
                {newIntents.length} intent{newIntents.length !== 1 ? 's' : ''}
              </span>
            </div>
            ...
            <div className="space-y-3">
              {newIntents.map(intent => (
                ...
                >
                  ...
                  <div className="text-sm text-slate-300 mb-2">{intent.thesis}</div>
          ...
          <div className="rounded-xl border border-purple-600 bg-purple-900/20 p-6 text-slate-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-purple-400">
                {devIntents.length} intent{devIntents.length !== 1 ? 's' : ''}
              </span>
            </div>
          ...
          <div className="rounded-xl border border-slate-700 p-8 text-center text-slate-200">
            <div className="mb-4">
              ...
              <p className="text-slate-400 mb-6 max-w-md mx-auto">
                Create AI predictions in Studio, then click "🚀 Trade This Prediction" to generate
                trading intents. This is the only way to create new intents.
              </p>
              <a
                href="/studio"
                ...
                <div>
                  ...
                  <div
                    className={`text-lg font-semibold ${
                      draft.direction === 'Long' ? 'text-green-400' : 'text-red-400'
                    }`}
                  >
                    {draft.direction}
                  </div>
        ...
        <div className="rounded-xl border border-slate-700 p-6 text-slate-200">
          ...
          <div className="space-y-4">
            <div className="bg-slate-800/30 rounded-lg p-4">
              ...
              <p className="text-sm text-slate-400">
                Consider rebalancing your portfolio based on current market conditions and your risk
                tolerance.
              </p>
            </div>
            ...
            <div className="bg-slate-800/30 rounded-lg p-4">
              ...
              <p className="text-sm text-slate-400">
                Implement a dollar-cost averaging strategy for stable long-term growth.
              </p>
            </div>
            ...
            <div className="bg-slate-800/30 rounded-lg p-4">
              ...
              <p className="text-sm text-slate-400">
                Set up stop-loss orders to protect your investments from significant downturns.
              </p>
            </div>
          </div>
        </div>
