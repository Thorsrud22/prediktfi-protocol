...
export default function PredictionDetail({ insight, id }: PredictionDetailProps) {
  ...
  const getStatusColor = () => {
    if (isResolved && insight.outcome) {
      switch (insight.outcome.result) {
        case 'YES': return 'from-green-500 to-emerald-600';
        case 'NO': return 'from-red-500 to-rose-600';
        case 'INVALID': return 'from-yellow-500 to-amber-600';
      }
    }
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-10 shadow-2xl">
            ...
            <div className="text-center mb-10">
              <div className="relative inline-block mb-6">
                <div className={`w-56 h-56 rounded-full bg-gradient-to-br ${getProbabilityColor(insight.p)} flex items-center justify-center shadow-2xl relative overflow-hidden`}>
                  {/* Animated ring */}
                  <div className="absolute inset-0 rounded-full border-4 border-white/20 animate-spin" style={{ animationDuration: '3s' }} />
                  <div className="absolute inset-2 rounded-full border-2 border-white/10 animate-spin" style={{ animationDuration: '2s', animationDirection: 'reverse' }} />
              ...
              <div className="flex justify-center items-center gap-6">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
                  ...
                  <div className="text-left">
                    ...
                    <div className={`text-sm font-bold ${confidence.color}`}>{confidence.level}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
                  ...
                  <div className="text-left">
                    ...
                    <div className={`text-sm font-bold ${isOverdue ? 'text-red-400' : 'text-blue-400'}`}>
              ...
              <div className="flex items-center justify-center mb-6">
                ...
                >
                  <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/20 hover:bg-white/15 hover:border-white/30 cursor-pointer">
                    ...
                    <div>
                      <div className="text-white font-semibold group-hover:text-blue-200 transition-colors">@{insight.creator.handle}</div>
              ...
              <div className="mb-8">
                <div className={`bg-gradient-to-r ${getStatusColor()} rounded-2xl p-6 text-center`}>
                  ...
                  <p className="text-white/80 text-sm">
                    Decided by {insight.outcome.decidedBy.toLowerCase()} on {new Date(insight.outcome.decidedAt).toLocaleDateString()}
                  </p>
                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white/5 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-white mb-1">{probabilityPercent}%</div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <div className={`px-2 py-1 rounded-full text-xs font-medium inline-block ${
                    insight.status === 'COMMITTED' ? 'bg-green-500/20 text-green-400' :
                    insight.status === 'RESOLVED' ? 'bg-blue-500/20 text-blue-400' :
