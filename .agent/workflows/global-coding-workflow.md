---
description: Global coding workflow: plan first, strict scope, incremental commits, tests as gates, reset to last green when stuck, prototype complex features, keep modules small.
---
