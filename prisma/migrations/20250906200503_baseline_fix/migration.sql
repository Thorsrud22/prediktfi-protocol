...
INSERT INTO "new_insights" ("canonical", "category", "confidence", "createdAt", "creatorId", "dataQuality", "deadline", "horizon", "id", "intervalLower", "intervalUpper", "memoSig", "metrics", "modelVersion", "p", "probability", "question", "rationale", "resolverKind", "resolverRef", "scenarios", "slot", "sources", "stampId", "stamped", "status", "txSig", "updatedAt") SELECT "canonical", "category", "confidence", "createdAt", "creatorId", "dataQuality", "deadline", "horizon", "id", "intervalLower", "intervalUpper", "memoSig", "metrics", "modelVersion", "p", "probability", "question", "rationale", "resolverKind", "resolverRef", "scenarios", "slot", "sources", "stampId", "stamped", "status", "txSig", "updatedAt" FROM "insights";
DROP TABLE "insights";
